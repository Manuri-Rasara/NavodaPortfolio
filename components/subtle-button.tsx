...
export default function BorderButton() {
  ...
  return (
    <div className='w-full flex justify-center items-center'>
      <button 
        className='group relative  border-2 flex justify-center items-center gap-3 border-black/70 rounded-full w-[9.3rem] h-15 
                   transition-all duration-500 ease-out hover:border-black hover:shadow-lg hover:shadow-white/20 
                   hover:scale-105 active:scale-95 overflow-hidden backdrop-blur-sm
                   before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent 
                   before:via-black/5 before:to-transparent before:translate-x-[-100%] 
      ...
      >
        ...
        {/* Text */}
        <span className='text-black font-medium tracking-wide text-sm transition-all duration-300 
