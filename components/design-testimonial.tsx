...
const testimonials = [
  {
    quote: "I’ve known Navoda since working together at the Information and Communication Technology Agency of Sri Lanka. She is a positive, disciplined, and dedicated professional with strong skills in project planning and management, web development, UI/UX, and HR capacity building",
    author: "Kasun Tharaka",
    role: "Director of IT @ ICTA",
  company: "ICTA",
  },
  {
          ...
          <div className="flex-1 pl-16 py-12">
            ...
            <div className="relative mb-12 min-h-[140px]">
              <AnimatePresence mode="wait">
                <motion.blockquote
                  key={activeIndex}
                  className="text-xl md:text-2xl font-light text-foreground leading-[1.15] tracking-tight w-4/5"
                  initial="hidden"
                  animate="visible"
                  exit="exit"
                >
